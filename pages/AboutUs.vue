...
<template>
  ...
  >
    <div
      class="w-full bg-hero-about-image bg-position-hero-about-image bg-size-hero-about-image bg-no-repeat h-80"
    ></div>
  </header>
  ...
  <main class="bg-[#141414] w-full">
    <section class="w-11/12 mx-auto">
      ...
      <MainBlock
        :headerText="cardHead_3"
        :paraText="cardPara_3"
      >
        <template #default>
          <div class="cardTAbout-cont">
            <CardTAbout />
          </div>
        </template>
      </MainBlock>
      ...
      <MainBlock
        :headerText="cardHead_5"
        :paraText="cardPara_5"
      >
        <!-- <template #default>
          <div class="flex flex-col gap-y-12 my-12">
            <ProfileCard
              :imageUrl="'/icons/ProfileMax.svg'"
              :name="'Max Mitchell'"
              :title="'Founder'"
            ...
            />
            <ProfileCard
              :imageUrl="'/icons/ProfileSara.svg'"
              :name="'Sara Johnson'"
            ...
            />
            <ProfileCard
              :imageUrl="'/icons/ProfileDavid.svg'"
              :name="'David Brown'"
            ...
            />
            <ProfileCard
              :imageUrl="'/icons/ProfileMichael.svg'"
              :name="'Michael Turner'"
              :title="'Legal Counsel'"
              :twitterUrl="'https://twitter.com/username'"
              :sayHelloText="'Say Hello 👋'"
